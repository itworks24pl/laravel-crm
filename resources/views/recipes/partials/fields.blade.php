<div class="row">
    <div class="col-sm-6 border-right">
        ...
        'value' => old('name', $recipe->name ?? null),
        'required' => 'true'
        ])
        <div class="row">
            <div class="col-sm-6">
                ...
                'value' => old('code', $recipe->code ?? null)
                ])
            </div>
            <div class="col-sm-6">
                @include('laravel-crm::partials.form.text',[
                ...
                'value' => old('code', $recipe->barcode ?? null)
                ])
            </div>
        </div>
        ...
        'value' => old('recipe_category', $recipe->recipeCategory->id ?? null)
        ])
        ...
        @include('laravel-crm::fields.partials.model', ['model' => $recipe ?? new \VentureDrake\LaravelCrm\Models\Recipe()])
